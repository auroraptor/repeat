  ...
  return (
    <>
      ...
      <div className={styles.lineRight} />
        ...
        <div className={`${styles.cloudPart} ${styles.cloudPartLeft} ${styles.part4left}`}></div>
        <div className={`${styles.cloudPart} ${styles.cloudPartLeft} ${styles.part5left}`}></div>
        <div className={`${styles.cloudPart} ${styles.cloudPartLeft} ${styles.part6left}`}></div>
      </div>
    </>
  );
}
